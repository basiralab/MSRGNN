"""
Generates comparative bar charts from TensorBoard logs for O3 experiments.
...
METRIC_TAG = 'Accuracy/test'

EXPERIMENT_GROUPS = {
    "RADIO_2 to O3 TL": r"^O3_5-(.+)-TRANSFER_RADIO_2$",
    "RADIO to O3 TL":   r"^O3_5-(.+)-TRANSFER_RADIO$",
    "I_RAVEN to O3 TL": r"^O3_5-(.+)-TRANSFER$",
    "O3 STL":           r"^O3_5-(.+)$",
}
...
def plot_detailed_fold_chart(group_title, results, output_path, metric_name):
    ...
    # Determine grid size (prefer wider layouts)
