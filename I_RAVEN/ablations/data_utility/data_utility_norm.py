...
class dataset(Dataset):
    def __init__(self, args, mode, rpm_types, transform=None, transform_p=1.0):
        ...
        self.ctx_size = 8  # Number of context images.
        self.candidate_size = 8  # Number of candidate images.
    ...
    def __getitem__(self, idx):
        ...
        images = images.unsqueeze(1)  # Add channel dimension with value 1 in index 2
