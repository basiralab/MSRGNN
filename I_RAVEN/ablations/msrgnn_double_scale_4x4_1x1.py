...
def main():
    ...
    writer = SummaryWriter(log_dir='runs/RAVEN_MSRGNN_4x4_1x1')
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            epochs_without_improvement = 0
            torch.save(model.state_dict(), "./saved_models/best_model_msrgnn_double_scale_4x4_1x1.pth")
    ...
    torch.save(model.state_dict(), "./saved_models/model_final_msrgnn_double_scale_4x4_1x1.pth")
    print("Training complete. Model saved as 'model_final_msrgnn_double_scale_4x4_1x1.pth'.")
    ...
    model.load_state_dict(torch.load("./saved_models/best_model_msrgnn_double_scale_4x4_1x1.pth"))
    model.eval()
