...
class SharedGNNReasoner(nn.Module):
    ...
    def forward(self, node_features_dict, batch_indices, edge_index, num_nodes_per_graph=9):
        ...
        # ], dim=-1)
        pooled = global_max_pool(h2, batch_indices)
...
def main():
    ...
    writer = SummaryWriter(log_dir='runs/RAVEN_MSRGNN_GLOBAL_MAX_POOL')
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            epochs_without_improvement = 0
            torch.save(model.state_dict(), "./saved_models/best_model_msrgnn_global_max_pool.pth")
    ...
    torch.save(model.state_dict(), "./saved_models/model_final_msrgnn_global_max_pool.pth")
    print("Training complete. Model saved as 'model_final_msrgnn_global_max_pool.pth'.")
    ...
    model.load_state_dict(torch.load("./saved_models/best_model_msrgnn_global_max_pool.pth"))
    model.eval()
