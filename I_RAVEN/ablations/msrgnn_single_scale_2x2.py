...
class MSRGNN(nn.Module):
    ...
    def __init__(self, ctx_size=8, cand_size=8, resnet_base_channels=64,
        ...
        self.extractor = SingleScaleResNetExtractor(in_ch=1, base_channels=resnet_base_channels, pool_size=2)
...
def main():
    ...
    writer = SummaryWriter(log_dir='runs/RAVEN_MSRGNN_SINGLE_SCALE_2x2')
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            epochs_without_improvement = 0
            torch.save(model.state_dict(), "./saved_models/best_model_msrgnn_single_scale_2x2.pth")
    ...
    torch.save(model.state_dict(), "./saved_models/model_final_msrgnn_single_scale_2x2.pth")
    print("Training complete. Model saved as 'model_final_msrgnn_single_scale_2x2.pth'.")
    ...
    model.load_state_dict(torch.load("./saved_models/best_model_msrgnn_single_scale_2x2.pth"))
    model.eval()
