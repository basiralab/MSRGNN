...
def main():
    ...
    writer = SummaryWriter(log_dir='runs/RAVEN_MSRGNN_FUSION')
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            epochs_without_improvement = 0
            torch.save(model.state_dict(), "./saved_models/best_model_msrgnn_fusion.pth")
    ...
    torch.save(model.state_dict(), "./saved_models/model_final_msrgnn_fusion.pth")
    print("Training complete. Model saved as 'model_final_msrgnn_fusion.pth'.")
    ...
    model.load_state_dict(torch.load("./saved_models/best_model_msrgnn_fusion.pth"))
    model.eval()
