...
class GatedGNNRelationLayerV2(MessagePassing):
    ...
    def message(self, x_i, x_j, pos_emb_i, pos_emb_j, integrated_x_i, integrated_x_j, edge_index_i):
        ...
        gated_message = relational_message
...
def main():
    ...
    writer = SummaryWriter(log_dir='runs/RAVEN_MSRGNN_NO_GATE')
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            epochs_without_improvement = 0
            torch.save(model.state_dict(), "./saved_models/best_model_msrgnn_no_gate.pth")
    ...
    torch.save(model.state_dict(), "./saved_models/model_final_msrgnn_no_gate.pth")
    print("Training complete. Model saved as 'model_final_msrgnn_no_gate.pth'.")
    ...
    model.load_state_dict(torch.load("./saved_models/best_model_msrgnn_no_gate.pth"))
    model.eval()
