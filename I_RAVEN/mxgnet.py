...
def train_epoch(model, loader, optimizer, criterion, device):
    ...
    for imgs, labels in tqdm(loader, desc="Training"):
        ...
        imgs = imgs.view(-1, 16, model.A, model.B)  # Reshape to (batch_size, 1, A, B)
...
def main():
    ...
    writer = SummaryWriter(log_dir='runs/RAVEN_MXGNET')
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            epochs_without_improvement = 0
            torch.save(model.state_dict(), "./saved_models/best_model_mxgnet.pth")
    ...
    torch.save(model.state_dict(), "./saved_models/model_final_mxgnet.pth")
    print("Training complete. Model saved as 'model_final_mxgnet.pth'.")
    ...
    model.load_state_dict(torch.load("./saved_models/best_model_mxgnet.pth"))
    model.eval()
